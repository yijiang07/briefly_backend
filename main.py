...
# ── LOGO (real SVG) ──
LOGO_SVG = '<svg width="48" height="48" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" style="display:inline-block;vertical-align:middle;"><g fill="none" stroke-linecap="round" stroke-linejoin="round"><path d="M260 397 H360" stroke="#3157FF" stroke-width="22"/><path d="M225 462 H355" stroke="#3157FF" stroke-width="22"/><path d="M260 527 H335" stroke="#3157FF" stroke-width="22"/><path d="M386 309 C466 244 620 244 701 309" stroke="#3157FF" stroke-width="22"/><path d="M386 715 C466 780 620 780 701 715" stroke="#3157FF" stroke-width="22"/><circle cx="544" cy="512" r="180" stroke="#111111" stroke-width="26"/><path d="M364 512 H724" stroke="#111111" stroke-width="24"/><path d="M544 332 C485 385 455 447 455 512 C455 577 485 639 544 692" stroke="#111111" stroke-width="24"/><path d="M544 332 C603 385 633 447 633 512 C633 577 603 639 544 692" stroke="#111111" stroke-width="24"/><path d="M544 332 V692" stroke="#111111" stroke-width="24"/></g></svg>'
  ...
  <div style="max-width:600px;margin:0 auto;padding:32px 16px;">
    ...
    <div style="border-bottom:1px solid #e8e4dc;padding-bottom:20px;margin-bottom:28px;">
      <div style="display:flex;align-items:center;gap:8px;margin-bottom:4px;">
        {LOGO_SVG}
        <span style="font-family:Georgia,serif;font-size:22px;font-weight:400;">Briefly</span>
      </div>
